...
async function getMarketsBatch(opts) {
	const body = {
		mints: opts.mints ?? null,
		tickers: opts.tickers ?? null
	};
	return requestJson(base$1(), "/api/v1/markets/batch", {
		method: "POST",
		body
	});
}
...
//#endregion
export { getTradesByMint as _, getEvent as a, getSolanaRpcUrl as b, getMarketByMint as c, getOrderbookByMint as d, getOrderbookByTicker as f, getTrades as g, getTagsByCategories as h, filterOutcomeMints as i, getMarkets as l, getSeriesByTicker as m, getOrderStatus as n, getEvents as o, getSeries as p, getTokensWithDecimals as r, getMarket as s, getOrder as t, getMarketsBatch as u, searchEvents as v, ApiError as y };
//# sourceMappingURL=trade-COyiDZdi.mjs.map